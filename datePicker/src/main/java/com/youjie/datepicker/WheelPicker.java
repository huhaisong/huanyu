...
import com.youjie.datepicker.util.LinearGradient;
...
public class WheelPicker<T> extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(mIndicatorText)) {
            canvas.drawText(mIndicatorText, mFirstItemDrawX + (mTextMaxWidth >> 1), mCenterItemDrawnY, mIndicatorPaint);
        }
    }
