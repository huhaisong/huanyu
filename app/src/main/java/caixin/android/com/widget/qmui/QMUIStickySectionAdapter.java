package caixin.android.com.widget.qmui;/*
...
import static caixin.android.com.widget.qmui.QMUISection.ITEM_INDEX_CUSTOM_OFFSET;
import static caixin.android.com.widget.qmui.QMUISection.ITEM_INDEX_LOAD_AFTER;
import static caixin.android.com.widget.qmui.QMUISection.ITEM_INDEX_LOAD_BEFORE;
import static caixin.android.com.widget.qmui.QMUISection.ITEM_INDEX_SECTION_HEADER;
...
public abstract class QMUIStickySectionAdapter<
    ...
    public int findCustomPosition(int sectionIndex, int customItemIndex, boolean unFoldTargetSection) {
        int itemIndex = ITEM_INDEX_CUSTOM_OFFSET + customItemIndex;
    ...
    public final void onBindViewHolder(@NonNull final VH vh, int position) {
        ...
        if (itemIndex == ITEM_INDEX_SECTION_HEADER) {
            ...
            onBindCustomItem(vh, position, section, itemIndex - ITEM_INDEX_CUSTOM_OFFSET);
        }
