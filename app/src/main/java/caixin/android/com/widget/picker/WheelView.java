...
public class WheelView extends View {
    ...
    private static final float SCALE_CONTENT = 0.6F;//非中间文字则用此控制高度，压扁形成3d错觉
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.dp_30);//默认大小
...
//                canvas.scale(1.0F, (float) Math.sin(radian));
     ...
     *
     * @param contentText item text message.
     */
