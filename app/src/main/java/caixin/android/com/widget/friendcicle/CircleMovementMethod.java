...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = Application.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor =Application.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
