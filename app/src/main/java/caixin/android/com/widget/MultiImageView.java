...
//com.lotteryhouse.app.widget.MultiImageView
public class MultiImageView extends LinearLayout {
    ...
    private int pxImagePadding = DpUtil.dp2px(3);// 图片间的间距
    ...
    private void initView() {
        ...
        if (imagesList == null || imagesList.size() == 0||(imagesList.size() == 1&& TextUtils.isEmpty(imagesList.get(0)))) {
            return;
        }
    ...
    private View createImageView(int position, final boolean isMultiImage) {
        ...
        ImgLoader.normalGlide(imageView, url, R.mipmap.web_default);
