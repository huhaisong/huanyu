...
public class DragImageView extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public void setUp(Bitmap cover, Bitmap block) {
        ...
        l.width = ScreenDimenUtil.dp2px( (float) w);
        l.height = ScreenDimenUtil.dp2px( (float) h);
        ...
        layoutParams2.width = ScreenDimenUtil.dp2px(  (float) block.getWidth());
        layoutParams2.height = ScreenDimenUtil.dp2px(  (float) block.getHeight());
    ...
    private void setLocation(float cover_wph, int cover_w) {
        ...
        layoutParams.width = ScreenDimenUtil.dp2px( (float) w);
        layoutParams.height = ScreenDimenUtil.dp2px( (float) h);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (dragListenner != null) {
            dragListenner.onDrag(ScreenDimenUtil.px2dip(
