...
import com.caixin.toutiao.databinding.ActivityAddGroupManagerBinding;
import com.caixin.toutiao.databinding.ActivityAddMemberBinding;
...
public class AddGroupManagerActivity extends BaseActivity<ActivityAddGroupManagerBinding, AddMemberViewModel> {

    public static final String DATAS = "AddGroupManagerActivity_DATA";
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        mBinding.buttonConfirm.setOnClickListener(v -> {
            ...
            mViewModel.addManager(editMangerRequest);
        });
    ...
    public void initViewObservable() {
        mViewModel.uc.addManager.observe(this, this::handleAddManager);
    }

    private void handleAddManager(Boolean aBoolean) {
        showShortToast("添加成功");
        //设置返回数据
