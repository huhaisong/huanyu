...
public class UserCenterModel extends BaseModel {
    ...
    public void httpResetPassword(BaseViewModel baseViewModel, String mobile, String code, Callback callback) {
        execute(getService(UserCenterService.class).resetPassword(mobile, code, MMKVUtil.getUserInfo().getToken()), callback, baseViewModel);
    }
