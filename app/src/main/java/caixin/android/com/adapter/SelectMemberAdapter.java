...
public class SelectMemberAdapter extends BaseMultiItemQuickAdapter<MemberEntity, BaseViewHolder> implements FloaterExtension, Filterable {

    Context mContext;
    private List<MemberEntity> originData;
    private RecyclerView mMyRecyclerView;

    public SelectMemberAdapter(Context context, RecyclerView recyclerView) {
        super(null);
...
//                    notifyDataSetChanged();
    ...
    //获得选中条目的结果
    public MemberEntity getSelectedItem() {
        for (int i = 0; i < getData().size(); i++) {
