...
public class LiuHeQueryBoSeAdapter extends BaseQuickAdapter<LHCYModel.ItemModel, BaseViewHolder> {
    public LiuHeQueryBoSeAdapter(@Nullable List<LHCYModel.ItemModel> data) {
        super(R.layout.rv_liuhe_query_bose_item, data);
    }
